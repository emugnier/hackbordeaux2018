...
class Patients(Resource):
    def get(self, patient_id, pwd_hash):
        ...
        #        return {'status':'wrong password'}
            ...
            status_query = conn.execute("select DATE, TIMESTAMP, STATUS, STATE from UserDetails where ID = '%s' order by desc TIMESTAMP "%patient_id)
...
api.add_resource(Patients, '/patients/<string:patient_id>/<string:pwd_hash>')
api.add_resource(Status, '/patients/<string:patient_id>/<string:pwd_hash>')
